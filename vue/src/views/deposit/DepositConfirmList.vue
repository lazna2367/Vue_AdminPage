  ...
  <div class="animated fadeIn">
    ...
    <b-row style="word-break: break-all; text-align: center; ">
      <b-col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
        <c-table :table-data="items" :fields="fields" caption="<i class='icon-check'></i> 입금완료 리스트"></c-table>
      </b-col>
...
import cTable from '../deposit/DepositConfirmListTable.vue'
...
export default {  
  ...
  methods:{
    axiosload() {
      const baseURI = 'http://172.30.1.46:8091/depositConfirmList'
