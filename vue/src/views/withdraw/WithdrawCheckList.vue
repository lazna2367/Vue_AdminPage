  ...
  <div class="animated fadeIn">
    ...
    <b-row style="word-break: break-all; text-align: center; ">
      <b-col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12>
        <c-table :table-data="items" :fields="fields" caption="<i class='icon-refresh'></i> 출금승인 관리 테이블"></c-table>
      </b-col>
...
import cTable from '../withdraw/WithdrawCheckListTable.vue'
  ...
  data: () => {
    return {
      ...
      fields: [
        ...
        {key: 'Complete' , label: '승인여부' , sortable: true }, //승인여부        
